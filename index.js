...
console.log(makePersonObject(5, 'Leia', 'leia.com'))
...
function getCarInfoById(inventory, id) {
    const uniqueId = inventory.find(() => {
        return id===1
    })
        return `This is a ${uniqueId.car_make} ${uniqueId.car_model}`
}
